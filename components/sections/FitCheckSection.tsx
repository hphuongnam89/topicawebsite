        ...
        <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-[42ch] text-body-lg text-ink-600">
              Bạn chưa cần quyết định ngay. Hãy kiểm tra điều kiện và nhận lộ trình trước khi để lại
              hồ sơ.
            </p>
            <ButtonLink
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {homepageContent.fitProfiles.map((profile, index) => {
              ...
              return (
                <article
                  key={profile.title}
                  className="min-w-0 border-t-2 border-brand-500 bg-canvas p-5 sm:p-6"
                >
