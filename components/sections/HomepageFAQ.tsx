      ...
      <Container>
        <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20">
          <ScrollReveal variant="slideInLeft">
            <div>
              ...
              <p className="mt-5 max-w-[35ch] text-body text-ink-600">
                Những thông tin quan trọng được trình bày theo nguồn chính thức và phạm vi áp dụng
                của từng thông báo.
              </p>
              <ButtonLink
          ...
          <div className="divide-y divide-line-200 border-y border-line-200">
            {homepageContent.faqs.map(([question, answer], index) => (
              <ScrollReveal key={question} delay={index * 0.03}>
