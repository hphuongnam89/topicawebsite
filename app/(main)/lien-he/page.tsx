        ...
        <Container>
          ...
          <div className="mt-9 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {campuses.map((campus, index) => (
              <ScrollReveal key={campus.city} delay={index * 0.05} className="h-full">
                <article className="h-full rounded-xl border border-line-200 bg-canvas p-6 transition-all hover:border-brand-300 hover:shadow-md">
